  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const { data: xpSettings } = await supabase
        ...
        .in('action', [
          'add_fantasy', 'plan_fantasy', 'complete_fantasy',
          'evaluate_partial', 'complete_subgoal'
        ]);
      ...
      const checkinXp = (pendingCheckins?.length || 0) * (xpMap['evaluate_partial_'] || 0);
      ...
      setPotentialXp(fantasyXp + checkinXp + subgoalXp);
    };
