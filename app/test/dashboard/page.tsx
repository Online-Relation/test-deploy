...
export default function DashboardSpotlightWidget() {
  ...
  const sexMessage = newPercentage < 20
    ? `<span class='text-purple-500'>Det ser ud til I er ved at komme ind i rutine, hvor I ikke prøver noget nyt. I <strong><u>${newPercentage}%</u></strong> af jeres sexliv prøver I noget nyt. Måske I skulle tage en snak om noget nyt I begge har lyst til at prøve.</span>`
    : `<span class='text-purple-500'>🔥 Godt gået! I <strong><u>${newPercentage}%</u></strong> af jeres sexliv prøver I noget nyt – det ligner et eventyr i har gang i! Bliv ved med at udforske hinandens lyster.</span>`;
